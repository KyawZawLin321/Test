...
<div class="main_contents">
	<div id="sub_content">
		<form:form action="/auth/newpassword" method="post"
			class="was-validated" modelAttribute="user">
	
			<h2 class="col-md-6 offset-md-2 mb-5 mt-4">Reset Password</h2>
			...
			<div class="row mb-4">
				...
				<div class="col-md-4">
					<form:password  class="form-control" id="comfirmPassword" path="comfirmPassword"
						required="required"/>
				</div>
			</div>
			...
			<div class="row mb-4">
				...
				<div class="col-md-6">
					...
					<button type="submit" class="btn btn-secondary col-md-2"
						data-bs-toggle="modal" data-bs-target="#exampleModal">Save</button>
